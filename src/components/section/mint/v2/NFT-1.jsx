...
const Mint = () => {
  const [Transfer,setTransfer]=useState()
    ...
    const { CreateContractInstance,Contract,Basic,account,mintModalHandle } = useModal();
    ...
    const getNextMint=async()=>{
        ...
        try{
            const TokenOwner= await Contract.methods.ownerOf(params.product).call();
              ...
              <div className="mint_left_content">
                <div className="mint_left_inner">
                  <div className="mint_slider">
                          ...
                          {product?<img src={product.image} alt="thumb"  />:<h1>......</h1>}
            ...
            <div className="col-md-6">
              <div className="mint_right_content">
                ...
                <div className="mint_timer">
                  ...
                  <p style={{marginTop:"10px",fontSize:"25px"}}>{product?<>{product.description}</>:<></>}</p>
                 
                </div>
                <div className="content_footer">
                <h3 style={{color:"white"}}>Owner OF NFT</h3>
                  {console.log("OWNER:"+NftOwner)}
                  <p style={{marginTop:"10px",fontSize:"25px"}}> {NftOwner?<>{NftOwner}</>:<></>}</p>
                ...
                <div className="mint_btns">
                  ...
                  {account[0]==Transfer?
                    <Button lg variant="outline"  style={{background:"#00ffa3",color:"black"}} onClick={()=>mintModalHandle()} >
